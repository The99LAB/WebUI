<template>
    <q-select label="Storage pool" v-model="selectedStoragePool" :options="storagePoolList" option-label="name" @update:model-value=updateVolumesList()>
    ...
    <q-select label="Volume" v-model="selectedVolume" :options="volumesList" option-label="name">
        <template v-slot:option="scope">
          <q-item v-bind="scope.itemProps">
            <q-item-section>
