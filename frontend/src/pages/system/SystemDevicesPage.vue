        ...
        <q-tr v-show="props.row.expand" :props="props">
          <q-td colspan="100%" no-hover>
            <div class="q-gutter-sm q-ml-xs">
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Location:</p>
                <p class="text-body2 q-my-none">{{ props.row.path }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Domain:</p>
                <p class="text-body2 q-my-none">{{ props.row.domain }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Bus:</p>
                <p class="text-body2 q-my-none">{{ props.row.bus }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Slot:</p>
                <p class="text-body2 q-my-none">{{ props.row.slot }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Function:</p>
                <p class="text-body2 q-my-none">{{ props.row.function }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Vendor ID:</p>
                <p class="text-body2 q-my-none">{{ props.row.vendor_id }}</p>
              </div>
              <div class="row">
                <p class="text-body2 text-weight-bold q-mr-sm q-my-none">Product ID:</p>
