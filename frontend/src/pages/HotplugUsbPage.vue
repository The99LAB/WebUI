<template>
  <q-page padding>
    ...
    <div class="row">
      ...
      <q-btn label="Remove device from vm" color="primary" @click="removeHotplugUsb"/>
    </div>
...
export default {
  ...
  methods: {
    addHotplugUsb() {
      ...
      if (this.$refs.usbDevicesList.getSelectedUsbVendorId() == null ||
      ...
      this.$api.post (
        "/vm-manager/"+ this.$refs.vmList.getSelectedVm()['uuid'] + "/edit-usbhotplug-add",
        {
