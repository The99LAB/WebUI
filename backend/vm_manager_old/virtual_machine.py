...
class VirtualMachine:
    ...
    def get_vm_memory_info(self):
        ...
        min_memory_conversion = convertSizeUnit(size=domain_memory_info[1], from_unit=SizeUnit.KB, mode=ConvertSizeUnitMode.INT_STR_TUPLE)
        max_memory_conversion = convertSizeUnit(size=domain_memory_info[2], from_unit=SizeUnit.KB, mode=ConvertSizeUnitMode.INT_STR_TUPLE)
    ...
    def set_vm_memory(self, min_memory, max_memory, min_memory_unit, max_memory_unit, memory_backing=False):
        min_memory_kb = convertSizeUnit(size=min_memory, from_unit=min_memory_unit, to_unit=SizeUnit.KB, mode=ConvertSizeUnitMode.INT)
        max_memory_kb = convertSizeUnit(size=max_memory, from_unit=max_memory_unit, to_unit=SizeUnit.KB, mode=ConvertSizeUnitMode.INT)
